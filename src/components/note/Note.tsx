            ...
            <div className="card-body">
              ...
              {this.props.note.isDone ?
                <button onClick={this.handleMarkAsDone}
                  ...
                  disabled={this.props.note.isArchived}>✔️</button> :
                <button onClick={this.handleMarkAsDone}
                  className="btn btn-success btn-sm"
                  disabled={this.props.note.isArchived}>⚫</button>}
                ...
                className="btn btn-success btn-sm">📩 unarchive</button>:
                <button onClick={this.handleArchive}
                  className="btn btn-secondary btn-sm">📩 archive</button>}
              </div>
